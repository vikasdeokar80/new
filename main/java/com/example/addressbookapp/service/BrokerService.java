...
public class BrokerService {
    ...
    public BrokerProfile create(BrokerDto brokerDto) {
        ...
        brokerProfile.setBroker_id(brokerDto.getBroker_id());
        brokerProfile.setName(brokerDto.getName());
        brokerProfile.setDocNumber(brokerDto.getDocNumber());
        brokerProfile.setFullAddress(brokerDto.getFullAddress());
        brokerProfile.setCity(brokerDto.getCity());
